		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#invoicessapui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"invoicessapui5-display": {
								"semanticObject": "invoicessapui5",
								"action": "display",
								"description": "Invoices List App",
								"title": "Invoices List",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=invoices.sapui5",
									"url": sap.ui.require.toUrl("invoices/sapui5")
								}
							}
						}
					}
